...
# Standardmaessig fuer VM 2 auf bucket2 gesetzt
BUCKET_NAME = os.getenv("S3_BUCKET", "bucket2")
...
class Video(Base):
    ...
    origin = Column(String, default="App 2")
...
async def upload_video(
    ...
    # Vergibt die ID basierend auf der aktuellen VM Umgebung
